<nav
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        @if (!in_array(explode('.', Route::currentRouteName())[1], ['index']))
            <span class="fw-bold navbar-brand mb-0 h1 px-1 text-secondary lh-1"> >
                {{ ucfirst(explode('.', Route::currentRouteName())[1]) }}
       </span>
        @endif
                        ...
                        <a class="dropdown-item" href="#">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <span class="fw-medium d-block" style="color: var(--bs-heading-color)">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span>
                                </div>
                            </div>
                        </a>
                    </li>
